    ...
    <div class="speakers__grid">
        ...
        <?php foreach($ponentes as $ponente){ ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                        <source srcset="<?php echo  '/img/speakers/' . $ponente->imagen ;?>.webp" type="image/webp">
                        <source srcset="<?php echo  '/img/speakers/' . $ponente->imagen ;?>.png" type="image/webp">
                        <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo  '/img/speakers/' . $ponente->imagen ;?>.png" alt="Imagen Ponente ">
                </picture>
