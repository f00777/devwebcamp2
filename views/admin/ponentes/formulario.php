<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            value="<?php echo $ponente->nombre ?? null ?>"
        />
    </div>
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            value="<?php echo $ponente->apellido ?? null ?>"
        />
    </div>
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            value="<?php echo $ponente->pais ?? null ?>"
        />
    </div>
    ...
    <?php if(isset($imagen_actual)){ ?>
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen ;?>.png" type="image/webp">
