    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                ...
                <source srcset="<?php echo '/img/speakers/' . $evento->ponente->imagen ;?>.png" type="image/webp">
                <img class="evento__imagen-autor" loading="lazy" width="200" height="300" src="<?php echo '/img/speakers/' . $evento->ponente->imagen ;?>.png" alt="Imagen Ponente ">
            </picture>
